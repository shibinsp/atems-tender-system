...
const EvaluationPanel: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Scoring View */}
      {viewMode === 'scoring' && tender.status === 'Under Evaluation' && (
        <div className="space-y-6">
          {/* Progress Summary */}
          <Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">
                      {allBidsScored ? 'All Bids Evaluated' : 'Evaluation In Progress'}
                    </p>
        ...
        <div className="space-y-6">
          {rankingResult ? (
            <RankingDisplay
              ...
              onDeclareWinner={canManage ? handleDeclareWinner : undefined}
              showDeclareButton={canManage}
            />
          ) : (
            <Card>
              <CardContent className="py-12 text-center">
